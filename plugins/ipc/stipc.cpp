...
class stipc_plugin_t : public wf::plugin_interface_t
{
  ...
  public:
    ...
    ipc::method_callback layout_views = [] (Json::Value data)
    {
        auto views = wf::get_core().get_all_views();
        if (!data.isMember("views") || !data["views"].isArray())
        {
        ...
        for (auto v : data["views"])
        {
            ...
            {
                return view->get_id() == v["id"].asUInt();
            });
    ...
    ipc::method_callback create_wayland_output = [] (Json::Value)
    {
    ...
    std::variant<key_t, std::string> parse_key(Json::Value data)
    {
    ...
    ipc::method_callback feed_button = [=] (Json::Value data)
    {
    ...
    ipc::method_callback move_cursor = [=] (Json::Value data)
    {
    ...
    ipc::method_callback do_touch_release = [=] (Json::Value data)
    {
        auto finger = wf::ipc::json_get_int64(data, "finger");
    ...
    ipc::method_callback run = [=] (Json::Value data)
    {
        auto cmd = wf::ipc::json_get_string(data, "cmd");
        auto response = wf::ipc::json_ok();
        response["pid"] = wf::get_core().run(cmd);
        return response;
    };

    ipc::method_callback ping = [=] (Json::Value data)
    {
        return wf::ipc::json_ok();
    };

    ipc::method_callback get_display = [=] (Json::Value data)
    {
        Json::Value dpy;
    ...
    ipc::method_callback do_tool_button = [=] (Json::Value data)
    {
    ...
    ipc::method_callback do_tool_axis = [=] (Json::Value data)
    {
        auto x = wf::ipc::json_get_f64(data, "x");
        auto y = wf::ipc::json_get_f64(data, "y");
        auto pressure = wf::ipc::json_get_f64(data, "pressure");
    ...
    ipc::method_callback do_pad_button = [=] (Json::Value data)
    {
        auto button = wf::ipc::json_get_int64(data, "button");
        auto state  = wf::ipc::json_get_bool(data, "state");
    ...
    ipc::method_callback delay_next_tx = [=] (Json::Value)
    {
    ...
    ipc::method_callback get_xwayland_pid = [=] (Json::Value)
    {
        auto response = wf::ipc::json_ok();
    ...
    ipc::method_callback get_xwayland_display = [=] (Json::Value)
    {
        auto response = wf::ipc::json_ok();
